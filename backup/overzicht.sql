...
CREATE TABLE `overzicht` (
  ...
  `Productcode fabrikant` varchar(20) DEFAULT NULL,
  `GLN fabrikant` bigint(13) DEFAULT NULL,
  `GTIN product` varchar(14) DEFAULT NULL,
  `Ingangsdatum` date DEFAULT NULL,
  `Locatie` varchar(200) DEFAULT NULL,
  `Productomschrijving` varchar(200) DEFAULT NULL,
  `Pspecificaties` varchar(255) DEFAULT NULL,
  `Statuscode` varchar(3) DEFAULT NULL,
  `GTIN product opvolger` varchar(14) DEFAULT NULL,
  `Productcode opvolger` varchar(20) DEFAULT NULL,
  `GTIN product voorganger` varchar(14) DEFAULT NULL,
...
INSERT INTO `overzicht` (`ID`, `Mutatiecode`, `Productcode fabrikant`, `GLN fabrikant`, `GTIN product`, `Ingangsdatum`, `Locatie`, `Productomschrijving`, `Pspecificaties`, `Statuscode`, `GTIN product opvolger`, `Productcode opvolger`, `GTIN product voorganger`, `Productcode voorganger`, `Netto gewicht`, `Eenheid gewicht`, `Aantal`, `Fabrikaat`, `Productserie`, `Producttype`, `imagelink`, `imagelink_2`, `imagelink_3`, `Code productgroep`, `Volgnummer productklasse`, `Versie normblad`, `Status normblad`, `updated_at`) VALUES
...
ALTER TABLE `overzicht`
  ADD PRIMARY KEY (`ID`),
  ADD UNIQUE KEY `Productcode fabrikant` (`Productcode fabrikant`);
